...
*/
  ...
  private void configureButtonBindings() {
    ...
    */
    ...
    // 1/2 Speed
    JoystickButton yellow = new JoystickButton(m_OI.Control3,Constants.TELESCOPE_UP_LEFT);
    yellow.whileHeld(new ShootingSpeed1(m_Shooting));
    // 1/3 Speed
    JoystickButton green = new JoystickButton(m_OI.Control3,Constants.TELESCOPE_UP_RIGHT);
    green.whileHeld(new ShootingSpeed2(m_Shooting));
    // 1/4 Speed
    JoystickButton blue = new JoystickButton(m_OI.Control2, Constants.CLIMB_UP_RIGHT);
    blue.whileHeld(new ShootingSpeed3(m_Shooting));
